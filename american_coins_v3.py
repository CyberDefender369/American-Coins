...
#empty list to contain specification rows of each coin
coin_row = []
...
for coin in coins:
    ...
    coin_row.append(string) #appending items to coin_row list
   
#dictionary to eliminate many if/elif statements
options = {
    "penny": coin_row[0],
    "nickel": coin_row[1],
    "dime": coin_row[2],
